...
Custom bar textures are loaded from the `data/graphic/1/mselect.ifs` file. [IFS LayeredIFS](https://github.com/mon/ifs_layeredfs/releases/) can be used to add or replace images without modifying the original file
